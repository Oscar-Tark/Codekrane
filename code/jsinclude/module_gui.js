...
var menus = 
{
	...
	'2' : '<div><label class="label_mid">> Portfolio</label><br><br><a href="javascript: scorpion(\'fnc.run(1)\');">View portfolio</a><br><br><label class="label_mid">> Running examples of projects</label><br><br><a href="https://www.codekrane.com/projects/cleanery" target="_new">Cleanery</a><br><br><label class="label_mid">> Links</label><br><br><a href="https://www.linkedin.com/in/oscartk/" target="_new">Linkedin</a><br><a href="https://github.com/Oscar-Tark" target="_new">Github</a><br><a href="https://bitbucket.org/%7B2a290b41-1933-4604-8eba-a92f90e6fbda%7D/" target="_new">Atlassian bitbucket</a></div>',
	
	'3' : '<div><label class="label_mid">> Contact</label><br><br><a href="mailto: oscar@protonmail.com">oscartark91@protonmail.com</a></div>',
