...
var functions = {
    ...
    breakdown : function(command){
        ...
        else if(command == "fnc.run('Portfolio')" || command == "fnc.run(1)")
        {
            ...
            executables.portfolio_header('My portfolio: [<label class="label_mid">Professional links:</label> <a href="https://www.linkedin.com/in/oscartk/" target="blank_">Linkedin</a> | Github | Atlassian Bitbucket | Sample code | Codeproject ]:');
